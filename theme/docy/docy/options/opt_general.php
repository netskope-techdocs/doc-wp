...
CSF::createSection( $prefix, array(
	...
	'fields'     => array(
		array(
			'title' => esc_html__( 'Post Types', 'docy' ),
			'id'    => 'post_options',
			'type'  => 'heading',
		),
		array(
			'title'    => esc_html__( 'Enable / Disable', 'docy' ),
			'subtitle' => esc_html__( 'If you disable a posttype, all the assets and elementor widgets of the post type will be disabled', 'docy' ),
