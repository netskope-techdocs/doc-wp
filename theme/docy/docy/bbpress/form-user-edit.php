...
<form id="bbp-your-profile" method="post" enctype="multipart/form-data">
	...
	<h2 class="entry-title"><?php esc_html_e( 'Name', 'docy' ) ?></h2>
	...
	<h2 class="entry-title"><?php esc_html_e( 'Contact Info', 'docy' ) ?></h2>

	<fieldset class="bbp-form">
		<legend><?php esc_html_e( 'Contact Info', 'docy' ) ?></legend>

		<?php do_action( 'bbp_user_edit_before_contact' ); ?>

		<div>
			<label for="url"><?php esc_html_e( 'Website', 'docy' ) ?></label>
	...
	<h2 class="entry-title"><?php bbp_is_user_home_edit()
		? esc_html_e( 'About Yourself', 'docy' )
		: esc_html_e( 'About the user', 'docy' );
	?></h2>
	...
	<fieldset class="bbp-form">
		...
		<div>
			<label for="description"><?php esc_html_e( 'Biographical Info', 'docy' ); ?></label>
	...
	<h2 class="entry-title"><?php esc_html_e( 'Account', 'docy' ) ?></h2>
	...
	<fieldset class="bbp-form">
		...
		<div>
			<label for="email"><?php esc_html_e( 'Email', 'docy' ); ?></label>
		...
		<div>
			<label for="url"><?php esc_html_e( 'Language', 'docy' ) ?></label>
	...
	<?php if ( ! bbp_is_user_home_edit() && current_user_can( 'promote_user', bbp_get_displayed_user_id() ) ) : ?>
		...
		<h2 class="entry-title"><?php esc_html_e( 'User Role', 'docy' ) ?></h2>
	...
	<fieldset class="submit">
		<legend><?php esc_html_e( 'Save Changes', 'docy' ); ?></legend>
		<div>
