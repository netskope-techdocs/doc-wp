...
add_filter( 'woocommerce_checkout_fields' , function ( $fields ) {
    ...
    $fields['billing']['billing_first_name'] = array(
        'label'         => '',
        'placeholder'   => esc_html_x( 'First name *', 'placeholder', 'docy' ),
    ...
    $fields['billing']['billing_last_name'] = array(
        'label'         => '',
        'placeholder'   => esc_html_x( 'Last name *', 'placeholder', 'docy' ),
        'class'         => array( 'col-md-6' ),
        'clear'         => true,
        'required'      => true
    );
    ...
    $fields['billing']['billing_company'] = array(
        'label'         => '',
        'placeholder'   => esc_html_x( "Company name", 'placeholder', 'docy' ),
    ...
    $fields['billing']['billing_city'] = array(
        'label'         => '',
        'placeholder'   => esc_html_x( 'Town / City *', 'placeholder', 'docy' ),
    ...
    $fields['billing']['billing_postcode'] = array(
        'label'         => '',
        'placeholder'   => esc_html_x( 'Postcode / ZIP (optional)', 'placeholder', 'docy' ),
        'class'         => array( 'col-md-12' ),
        'clear'         => true
    );
    ...
    $fields['billing']['billing_phone'] = array(
        'label'         => '',
        'placeholder'   => esc_html_x( 'Phone', 'placeholder', 'docy' ),
    ...
    $fields['billing']['billing_email'] = array(
        'label'         => '',
        'placeholder'   => esc_html_x( 'Email address *', 'placeholder', 'docy' ),
        'required'      => true,
    ...
    $fields['shipping']['shipping_company'] = array(
        'label'         => '',
        'placeholder'   => esc_html_x( 'Company name (optional)', 'placeholder', 'docy' ),
        'required'      => false,
        'class'         => array( 'col-md-12' ),
        'clear'         => true
    );
