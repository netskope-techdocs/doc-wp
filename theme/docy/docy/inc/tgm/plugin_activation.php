...
function docy_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(
            ...
            'source'        => 'https://wordpress-theme.spider-themes.net/resources/docy/docy-core_3.3.4.zip', // The plugin source.
		...
		array(
			...
			'slug'          => 'eazydocs',
            'source'        => 'https://wordpress-theme.spider-themes.net/3rd-plugins/eazydocs.zip', // The plugin source.
			'required'      => true,
		),
