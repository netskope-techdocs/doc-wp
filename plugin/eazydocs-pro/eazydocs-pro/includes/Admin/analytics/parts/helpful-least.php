                        ...
                        <div class="accordion-title ez-section-title expand--child has-child">
                            ...
                            <div class="right-content">
                                ...
                                if ( $positive | $negative ) {
                                    ...
                                    $positive_icon .= $positive > 0 ? '<div class="like"> <span class="t-success dashicons dashicons-thumbs-up"></span>'.$positive.'</div>' : '';
                                    $positive_icon .= '<div class="dislike"> <span class="t-danger dashicons dashicons-thumbs-down"></span> '.$negative .'</div>';
                                    $positive_icon .= '</div>';
                                }
