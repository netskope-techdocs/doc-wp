...
class Quote extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_alert',
            [
                'label' => __( 'Quote Texts', 'docy-core' ),
            ]
        );
...
about journalism.'
        ...
        $this->add_control(
            'name',
            [
                'label' => __( 'Quote Author Name', 'docy-core' ),
        ...
        $this->add_control(
            'designation',
            [
                'label' => __( 'Quote Author Designation', 'docy-core' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
            ]
        );
	    ...
	    $this->add_control(
		    'btm_text',
		    [
			    'label' => __( 'Bottom Text', 'docy-core' ),
			    'type' => Controls_Manager::TEXT,
			    'label_block' => true,
        ...
        $this->add_control(
            'quote_icon_left',
            [
                'label' => __( 'Quote Icon Top', 'docy-core' ),
        ...
        $this->add_control(
            'quote_icon_right',
            [
                'label' => __( 'Quote Icon Bottom', 'docy-core' ),
                'type' => Controls_Manager::MEDIA,
                'default' => [
	    ...
	    $this->add_control(
		    'right_image',
		    [
			    'label' => __( 'Right Side Image', 'docy-core' ),
			    'type' => Controls_Manager::MEDIA,
		    ]
	    );
	    ...
	    $this->add_control(
		    'background',
		    [
			    'label' => __( 'Background Circle Color', 'docy-core' ),
	    ...
	    $this->add_control(
		    'background2',
		    [
			    'label' => __( 'Background Circle Color 02', 'docy-core' ),
			    'type' => Controls_Manager::COLOR,
			    'selectors' => [
