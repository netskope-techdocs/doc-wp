                            ...
                            while ( $faqs->have_posts() ) : $faqs->the_post();
                                ...
                                <div class="card<?php echo esc_attr($active) ?>">
                                    <div class="card-header" id="heading-<?php echo $faq_i.$cat->slug.'-'; the_ID(); ?>">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link<?php echo esc_attr($is_collapsed) ?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-<?php echo $faq_i.$cat->slug.'-';the_ID(); ?>" aria-expanded="true" aria-controls="collapse-<?php echo $faq_i.$cat->slug.'-';the_ID(); ?>">
