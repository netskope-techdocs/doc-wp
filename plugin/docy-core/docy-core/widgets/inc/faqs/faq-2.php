<div class="doc_faq_area_two">
    <div class="row">
        ...
        <div class="col-lg-8 col-md-7">
            <div class="tab-content ps-4" id="myTabContent-<?php echo $this->get_id() ?>">
            <?php
            foreach ( $cats as $index => $cat ) :
                $tab_count = $index + 1;
                        ...
                        while ( $faqs->have_posts() ) : $faqs->the_post();
                            ...
                            <div class="card">
                                <div class="card-header" id="heading-<?php echo $cat->slug.$faq_i.'-'; the_ID(); ?>">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link<?php echo esc_attr($is_collapsed) ?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-<?php echo $cat->slug.$faq_i.'-';the_ID(); ?>" aria-expanded="<?php echo esc_attr($is_expanded) ?>" aria-controls="collapse-<?php echo $cat->slug.$faq_i.'-';the_ID(); ?>">
