...
class Info_box extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'url',
            [
                'label' => __( 'Description URL', 'docy-core' ),
        ...
        <div class="community-box">
            ...
            <div class="community-content">
                ...
                <?php if ( !empty($settings['link_title']) ) : ?>
                    <?php if ( !empty($settings['url']) ) : ?> <a <?php docy_el_btn($settings['url']) ?> class="details-link"> <?php endif; ?>
                        <?php echo esc_html($settings['link_title']) ?>
		            <?php if ( !empty($settings['url']) ) : ?> <i class="<?php docycore_arrow_left_right() ?>"></i> </a> <?php endif; ?>
                <?php endif; ?>
            </div>
        </div>
        <?php
