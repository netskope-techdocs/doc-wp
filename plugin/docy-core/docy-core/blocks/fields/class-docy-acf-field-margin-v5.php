...
if( !class_exists('docy_acf_field_margin') ) :


    class docy_acf_field_margin extends acf_field {
        ...
        */
        ...
        function __construct( $settings ) {
            ...
            */
            ...
            $this->label = __('Docy Margin', 'docy-core');
            ...
            */
            ...
            $this->l10n = array(
                'error'	=> __('Error! Please enter a higher value', 'docy-core'),
            );
        ...
        function render_field_settings( $field ) {
            ...
            */
            ...
            acf_render_field_setting( $field, array(
                'label'			=> __('Enable Field','docy-core'),
                'instructions'	=> __('Default','docy-core'),
                'type'			=> 'true_false',
                'name'			=> 'margin_enable',
                'layout'        => 'horizontal',
                'ui'			=> 0
            ...
            acf_render_field_setting( $field, array(
                'label'			=> __('Margin Right','docy-core'),
                'instructions'	=> __('Default','docy-core'),
                'type'			=> 'number',
                'name'			=> 'margin_right',
                'prepend'		=> 'px',
            ...
            acf_render_field_setting( $field, array(
                'label'			=> __('Margin Bottom','docy-core'),
                'instructions'	=> __('Default','docy-core'),
                'type'			=> 'number',
                'name'			=> 'margin_bottom',
                'prepend'		=> 'px',
            ...
            acf_render_field_setting( $field, array(
                'label'			=> __('Margin Left','docy-core'),
                'instructions'	=> __('Default','docy-core'),
                'type'			=> 'number',
                'name'			=> 'margin_left',
                'prepend'		=> 'px',
                ...
                <div class="acf-input">
                    <div class="acf-true-false">
                        <input type="checkbox"
                            ...
                            ?>
                        >
                        <label for="acfb_eye_margin_<?php echo $field['name']; ?>" id="acfb_eye_margin">
...
// initialize
    new docy_acf_field_margin( $this->settings );
