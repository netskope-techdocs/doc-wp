...
?>
    ...
    <div class="card forum-card">
        <a href="<?php the_permalink( $forum_id ); ?>" class="forum-card-thumbnail-area">
            <img src="<?php echo get_field('cc_img')['url']; ?>" class="card-img-top"
                 alt="<?php the_title_attribute( array( 'post' => $forum_id ) ) ?>">
            <ul class="forum-meta d-flex">
                <li class="topics" data-toggle="tooltip" data-placement="top" title="<?php _e( 'Topics', 'docy-core' ) ?>">
                ...
                <li class="replies" data-toggle="tooltip" data-placement="top"  title="<?php _e( 'Replies', 'docy-core' ) ?>">
        ...
        <div class="card-body">
            <div class="card-title">
                <a href="<?php the_permalink( $forum_id ); ?>">
					<h3><?php Docy_helper()->limit_latter( get_the_title( $forum_id ), 20 ); ?></h3>
                </a>
            </div>
			<?php echo wp_trim_words( get_the_content( null, false, $forum_id ), get_field('number_of_words') ); ?>
        </div>
    </div>
</div>
<?php
